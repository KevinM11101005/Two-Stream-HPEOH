...
from common.nets.cbam import SpatialGate_single, CBAM
...
class FPN(nn.Module):
    def __init__(self, pretrained=True):
        ...
        # Attention Module
        self.attention_module = SpatialGate_single()
    ...
    def forward(self, x):
        ...
        if cfg.att == 'cbam':
            best_feats = self.cbam(p2)
            return best_feats, primary_feats, secondary_feats
        else:
